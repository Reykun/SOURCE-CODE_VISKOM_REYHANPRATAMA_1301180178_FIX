# -*- coding: utf-8 -*-
"""yolo-v3-object-detection-in-tensorflow.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1o6SAGTANwaDFVsEGrlhIQyD08y4XAfhu
...
def draw_boxes(img_names, boxes_dicts, class_names, model_size):
    ...
    for num, img_name, boxes_dict in zip(range(len(img_names)), img_names,
        ...
        font = ImageFont.truetype(font='/content/drive/MyDrive/futur.ttf',
...
img_names = ['/content/drive/MyDrive/dog.jpg', '/content/drive/MyDrive/office.jpg']
...
class_names = load_class_names('/content/drive/MyDrive/coco.names')
...
assign_ops = load_weights(model_vars, '/content/drive/MyDrive/yolov3.weights')
...
with open('/content/drive/MyDrive/detections.gif') as f:
